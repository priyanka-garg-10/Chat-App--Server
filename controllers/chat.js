...
const addMembers = TryCatch(
    async (req, res, next) => {
        ...
        emitEvent(req, ALERT, chat.members, `${allUsersName} have been added in the group`);
        emitEvent(req, REFETCH_CHATS, chat.members);

        return res.status(200).json({
            success: true,
            message: "Mebers added successfully",
        });
    }
);
...
const removeMember = TryCatch(
    async (req, res, next) => {
        ...
        return res.status(200).json({
            success: true,
            message: "Mebers removed successfully",
        });
    }
);
...
const deleteChat = TryCatch(
    async (req, res, next) => {
        ...
        //Here we have to del all the attachments as well as attachments or files from cloudinary 
